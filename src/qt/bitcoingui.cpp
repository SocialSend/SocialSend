                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PIEX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PIEX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and piex: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PIEX Core"), this);
    aboutAction->setStatusTip(tr("Show information about PIEX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PIEX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PIEX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PIEX addresses"));
    ...
    openAction->setStatusTip(tr("Open a PIEX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PIEX Core help message to get a list with possible PIEX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PIEX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PIEX network", "", count));
}
...
{
    QString strTitle = tr("PIEX Core"); // default title
