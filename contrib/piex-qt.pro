...
RESOURCES += src/qt/piex.qrc src/qt/piex_locale.qrc

TRANSLATIONS += src/qt/locale/piex_bg.ts \
                src/qt/locale/piex_de.ts \
                src/qt/locale/piex_en.ts \
                src/qt/locale/piex_es.ts \
                src/qt/locale/piex_fi.ts \
                src/qt/locale/piex_fr.ts \
                src/qt/locale/piex_it.ts \
                src/qt/locale/piex_ja.ts \
                src/qt/locale/piex_pl.ts \
                src/qt/locale/piex_pt.ts \
                src/qt/locale/piex_ru.ts \
                src/qt/locale/piex_sk.ts \
                src/qt/locale/piex_sv.ts \
                src/qt/locale/piex_vi.ts \
                src/qt/locale/piex_zh_CN.ts \
                src/qt/locale/piex_zh_TW.ts
