...
This means one can have an always-on piexd instance running, and another local piexd/piex-qt instance which connects to this node and receives blocks from it.
