...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<piex_address\> \<monthly_payment_piex\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ PIEX, _12_ times over the course of a year totaling _24000_ PIEX.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<piex_address\> \<monthly_payment_piex\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` PIEX.
