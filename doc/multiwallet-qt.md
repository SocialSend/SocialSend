...
In order to support loading of multiple wallets in piex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is piex.cpp.
...
Changes to piex.cpp
----------------------
piex.cpp is the entry point into piex-qt, and as such, will require some minor modifications to provide hooks for
