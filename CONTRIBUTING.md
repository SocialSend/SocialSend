Contributing to SEND Core
============================

The SEND Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SEND Core project, and is not to be
confused with overall SEND Network Protocol consensus changes.

Whether a pull request is merged into SEND Core rests with the project merge
...
Patches that change SEND consensus rules are considerably more involved than
...
Where a patch set proposes to change the SEND consensus, it must have been
...
The project leader is the release manager for each SEND Core release.
