...
This mechanism has been integrated into Bitcore-Node-PIEX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PIEX-Project/insight-api-piex#web-socket-api](https://github.com/PIEX-Project/insight-api-piex#web-socket-api) 
* API: [https://github.com/PIEX-Project/insight-api-piex#swifttx-transactions](https://github.com/PIEX-Project/insight-api-piex#swifttx-transactions) 
...
By default, the PIEX Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PIEX Core daemon:
