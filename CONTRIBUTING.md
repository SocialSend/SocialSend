Contributing to PIEX Core
============================

The PIEX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PIEX Core project, and is not to be
confused with overall PIEX Network Protocol consensus changes.

Whether a pull request is merged into PIEX Core rests with the project merge
...
Patches that change PIEX consensus rules are considerably more involved than
...
Where a patch set proposes to change the PIEX consensus, it must have been
...
The project leader is the release manager for each PIEX Core release.
